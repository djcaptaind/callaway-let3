(() => {
  const STORAGE_KEY = "callaway-let3-week2-lesson1-v1";
  ...
  $("submitChallenge").addEventListener("click", () => {
    ...
    if (choice === "B") {
      feedback.innerHTML = "<strong>Strong leadership response.</strong> You chose direct communication, shared accountability, clear roles, and a specific follow-up point. This approach gives the team an opportunity to recover while maintaining standards.";
      feedback.className = "challenge-feedback show strong";
    } else {
      feedback.innerHTML = "<strong>Leadership growth opportunity.</strong> Your response may address part of the problem, but a stronger first move would combine direct communication, clear expectations, shared responsibility, and a follow-up deadline.";
      feedback.className = "challenge-feedback show developing";
    }
